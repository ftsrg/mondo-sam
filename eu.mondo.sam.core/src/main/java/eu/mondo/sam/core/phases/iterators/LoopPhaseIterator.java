...
public class LoopPhaseIterator implements Iterator<BenchmarkPhase> {
	 ...
	 * 
	 * @param loopPhase
	 *                LoopPhase object with initialized fields. It must
	...
	/**
	 * Returns an AtomicPhase object if the condition of the loopPhase
	 * proves true.
	 * 
	 ...
	 * 
	 * @return True, if the condition of the contained LoopPhase instance
	 *         proves true, and false in the other case.
	 */
	@Override
