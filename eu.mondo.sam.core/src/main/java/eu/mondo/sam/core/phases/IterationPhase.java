...
public class IterationPhase implements BenchmarkPhase {
	...
	/**
	 * Represents a maximum bound for the IterationPhaseIterator by
	 * restricting the access to the phase field of this class.
	 */
	...
	/**
	 * Parameterized constructor. The value of maxIteration attribute must
	 * be given.
	 * 
	 * @param maxIteration
	 *                Defines the maximum number of access to the phase
	 *                field.
	 */
	...
	/**
	 * Returns a new IterationPhaseIterator instance, which has a reference
