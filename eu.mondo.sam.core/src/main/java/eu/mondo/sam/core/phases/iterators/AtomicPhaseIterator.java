...
public class AtomicPhaseIterator implements Iterator<BenchmarkPhase> {
	...
	/**
	 * Determines whether the atomic object has been already accessed. In
	 * that case, the value is false. By default it is true.
	 */
	private boolean hasNext;

	/**
	 * Parameterized constructor. Makes reference to an AtomicPhase object,
	 * and initializes the hasNext variable with the value of true.
	 * 
	 * @param atomicPhase
