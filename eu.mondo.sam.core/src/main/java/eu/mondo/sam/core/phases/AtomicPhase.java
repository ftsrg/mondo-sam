...
public abstract class AtomicPhase implements BenchmarkPhase {
    ...
    /**
     * The identifier of AtomicPhase. The value of this variable will be showed
     * in the benchmark results too.
     */
    ...
    /**
     * Returns a new AtomicPhaseIterator instance, which has a reference to this
