...
public abstract class BenchmarkScenario {
    ...
    /**
     * An iterator of the rootPhase via which can access the AtomicPhase objects
     * from the hierarchy.
     */
     ...
     * 
     * @param runIndex
     *            An index of the currently running benchmark. Recommended to be
     *            unique in the case if the benchmark configuration parameters
     *            are the same.
     */
