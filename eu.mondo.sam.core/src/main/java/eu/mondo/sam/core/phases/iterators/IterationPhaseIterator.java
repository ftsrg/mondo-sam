...
public class IterationPhaseIterator implements Iterator<BenchmarkPhase> {
	...
	/**
	 * Refers to the iterator of the BenchmarkPhase instance which belongs
	 * to the iterationPhase variable.
	 */
	private Iterator<BenchmarkPhase> iterator;

	/**
	 * Parameterized constructor. Makes reference to a IterationPhase
	 * object, and initializes the local fields.
	 * 
	 * @param phase
	 *                IterationPhase object with initialized fields. It must
	 ...
	 * 
	 * @return True, if index is lower than maxIteration, and false in the
	 *         other case.
	 */
	@Override
